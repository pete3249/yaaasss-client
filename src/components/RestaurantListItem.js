        ...
        <div className="lg:m-4 shadow-md hover:shadow-lg hover:bg-yellow-200 rounded-lg bg-white my-12 mx-8 max-w-2xl mx-auto mt-10">
            ...
            <div className="p-4">
                ...
                <ul className="text-justify">
                    {restaurant.categories.map(category => <li key={category.alias} className="list-disc list-inside">{category.title}</li>)}
                ...
                <div className="flex justify-evenly mt-5">
                    ...
                    <a href="/events/new" className="hover:bg-gray-700 rounded-full py-2 px-3 font-semibold hover:text-white bg-gray-400 text-gray-100"> Create event</a>
                </div>
            </div>
        </div>
    )
